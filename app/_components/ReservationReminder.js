...
export default function ReservationReminder() {
    ...
    return (
        <div className='fixed bottom-6 left-1/2 -translate-x-1/2 py-5 px-8 rounded-full bg-amber-500 text-slate-800 font-semibold shadow-xl shadow-slate-900 flex gap-8 items-center'>
          <p>
